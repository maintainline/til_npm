...
- xhr,promis, fetch 로 다루던 `비동기 통신을 대체`함.
...
- 실제로 외부 데이터 연동은 상당히 많은 경우의 수가 있음.
...
export { getTodos, getTodo, postTodo, deleteTodo, putTodo, patchTodo };
```
